...
$pis = [
url('/storage/app/default/8/videos/015a1cf9239e37bda6a4cb86c586968b/thumb/foo-thumb-02.png') ,
...
<div class="container">
  <div class="row">
    ...
    <h5 style=" padding: 10px; text-transform: capitalize; border-bottom:solid 1px red; display:inline-block;">{{$cats[array_rand($cats)]}}</h5>
...
@foreach($videos as $video)
          ...
          <div class="card">
            <div class="card-image" title="channel name also chech if big what will do.">
              <a href="{{url('/v/'.$video->id)}}"><img src="{{asset('/images/bgTh.png')}}" data-src="{{url('/storage/app/default/'.$video->user_id.'/videos/'.$video->vid.'/thumb/foo-thumb-01.png')}}"></a>
            ...
            <div class="card-content">
              <h4 class="ellipsis" title="A Beautiful Mind Trailer">{{$video->title}}</h4>
              ...
              <span style="font-size: 10px; color: #666; margin-left: 33px; position: relative; top: -10px;">{{$video->created_at}}</span>
            </div>
          </div>
